...
export class WritingStyleManagerModal extends Modal {
  ...
  onOpen() {
    ...
    console.log('[WritingStyleManager] onOpen, styles count:', this.styles.length, this.styles);
  ...
  private async saveStyles() {
    ...
    console.log('[WritingStyleManager] Saved styles:', this.plugin.settings.savedWritingStyles.length);
  }
